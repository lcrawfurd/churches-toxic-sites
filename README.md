...
- By denomination within 5 km (OSM tag + name-inferred): Catholic ≈4,800, other Christian ≈6,700 (Pentecostal, Baptist, Evangelical, Adventist…), Anglican ≈240; ≈6,500 still unlabelled
...
tag + name-inferred class). The match covers explicit denomination words (in several languages); regional
denomination acronyms (ACK and CSI/CNI → Anglican; PCEA, CCAP → Presbyterian;
SDA → Adventist; KKKT, FLM → Lutheran; PAG, TAG, GSJA, ZAOGA → Assemblies of God;
GPdI, GBI, CCB, ICGC, CITAM → Pentecostal; AIC, PEFA, ECWA → Evangelical; EKAR →
Catholic; and many regional Protestant churches such as GKI, GMIM, UCCP, FJKM);
and a high-precision set of Catholic devotional/order/saint markers (Our Lady,
Sacred Heart, Comboni, parroquia, etc.). Explicit denominations take priority, so
e.g. "ACK St Teresa" stays Anglican. About 23% of untagged churches have a name
with a clear signal; ambiguous names (e.g. "St Mary's Church") are left Unspecified.
